...
#include <math.h>
/**
 * Retorna la posici�n en el arreglo del que corresponde a las coordenadas (x,y,z)
...
/**
 * Retorna la posici�n en el arreglo de F que corresponde a las coordenadas (x,y,z) y el eje que entra por parametro
