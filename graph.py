...
if sys.argv[1] == "shock":
	...
	plt.plot(y, rho_r, label = 'Analitica', color = 'r')
	plt.xlabel('$x$')
	plt.title(r'$\rho$''$(x, t=0.23)$')
	plt.legend()
	plt.savefig('rho.png')
	plt.close()

	plt.plot(x, P_f, label = 'Numerica')
	plt.plot(y, P_r, label = 'Analitica', color = 'r')
	plt.xlabel('$x$')
	plt.title('$P(x, t=0.23)$')
	plt.legend()
	plt.savefig('P.png')
	plt.close()

	plt.plot(x, u_f, label = 'Numerica')
	plt.plot(y, u_r, label = 'Analitica', color = 'r')
	plt.xlabel('$x$')
	plt.title('$u(x, t=0.23)$')
	plt.legend()
	plt.savefig('u.png')
	plt.close()
